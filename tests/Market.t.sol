...
contract MarketTest is BaseTest {
    ...
    function testSplitMerge() public {
        ...
        assertEq(
            ...
            initialCollateralBalance - splitAmount,
        ...
        assertEq(
            collateralToken.balanceOf(alice),
            initialCollateralBalance - splitAmount + mergeAmount,
            "Alice should have more collateral"
        );
        assertEq(
            collateralToken.balanceOf(address(market)), splitAmount - mergeAmount, "Market should hold less collateral"
        );
    ...
    function testSplitMergeMultipleUsers() public {
        ...
        assertEq(
            collateralToken.balanceOf(address(market)), aliceAmount + bobAmount, "Market should hold all collateral"
        );
    ...
    function testRevertWhenSplitWithInsufficientBalance() public {
    ...
    function testRevertWhenMergeWithUnbalancedPositions() public {
        uint256 splitAmount = 100 ether;
    ...
    function testRevertWhenMergeWithInsufficientPositions() public {
        uint256 splitAmount = 100 ether;
    ...
    function testConservationInvariant() public {
        ...
        assertEq(
            collateralToken.balanceOf(address(market)), remainingCollateral, "Market collateral incorrect after merge"
        );
    ...
    function testRevertWhenCreatePositionsWithoutCollateral() public {
